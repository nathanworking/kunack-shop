...
LOCAL_ROOT_PATH="./"
LOCAL_ASSETS_PATH=${LOCAL_ROOT_PATH}"assets/"

# Local user & group that should own the Craft CMS install
LOCAL_CHOWN_USER="docker"
LOCAL_CHOWN_GROUP="docker"
